# PowerShell script to login and save token
Write-Host "ROI Warehouse Management System - Login Script" -ForegroundColor Cyan
Write-Host "=================================================" -ForegroundColor Cyan

# Prompt for credentials (default to admin/admin for development)
$username = Read-Host -Prompt "Enter username (default: admin)"
if ([string]::IsNullOrWhiteSpace($username)) {
    $username = "admin"
}

$password = Read-Host -Prompt "Enter password (default: admin)"
